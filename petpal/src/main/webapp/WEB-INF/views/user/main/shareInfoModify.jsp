	...
	<jsp:include page="../common/userHeader.jsp"/>
		...
		<div class="blog-list" style="position: absolute; top:25%; width: 15%; margin-top: 45px;">
       	...
       	<section id="menutable" class="menutable">
			<form action="${pageContext.servletContext.contextPath}/user/update/modify/shareInfo" method="post" enctype="multipart/form-data">
				<div style="width: 70%; border: 1px solid rgba(175, 175, 175, 0.616); margin: 0px auto; border-radius: 20px; margin-bottom: 30px;">
					...
					<textarea name="boardContent" id="summernote">${ requestScope.modifyInfo.boardContent }</textarea>
	  				<script>
