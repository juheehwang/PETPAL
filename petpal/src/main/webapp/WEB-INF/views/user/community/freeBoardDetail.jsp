		            ...
		            <table class="table" style="margin-bottom: 50px; border-collapse: separate;">
						<tbody>
							<tr>
								...
								<span>
									<c:if test="${ requestScope.freeBoardDetail.userCode != sessionScope.loginUser.code && !empty sessionScope.loginUser.code }">
			                        	...
			                        	<tr>
			                            	...
			                            	<td>
			                            		<c:if test="${ arr.userCode != sessionScope.loginUser.code && !empty sessionScope.loginUser.code }">
			                            			<img onclick="test1(this)" class="${ arr.replyCode }" title="${ arr.userCode }" src="${ pageContext.servletContext.contextPath }/resources/images/report.jpg" style="width: 25px">
			                            		</c:if>
			                            	</td>
			                        	</tr>
			                        </c:if>
            ...
            <c:if test="${ !empty sessionScope.loginUser.code }">
	            <form action="${ pageContext.servletContext.contextPath }/user/insert/freeboard/reply" method="post">
		            <section id="sendmessage" class="sendmessage" style="width: 70%; margin: 0px auto; margin-bottom: 50px;">
		                <input type="text" id="replyContent" name="replyContent" placeholder="  message" required>
