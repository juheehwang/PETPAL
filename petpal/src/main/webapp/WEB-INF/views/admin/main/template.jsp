                ...
                <div class="container"> 
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#brand">
                            <img src="${ pageContext.servletContext.contextPath }/resources/images/logo.png" class="logo" alt="">
                            <!--<img src="${ pageContext.servletContext.contextPath }/resources/images/footer-logo.png" class="logo logo-scrolled" alt="">-->
                        </a>
                                    ...
                                    <div class="business_items text-center">
                                        <div class="business_item">
                                            <div class="business_img">
                                                <img src="${ pageContext.servletContext.contextPath }/resources/images/about-img1.jpg" alt="" />
                                            </div>
                                        </div>
                        ...
                        <div class="main_test fix">
                            ...
                            <div class="col-md-6">
                                <div class="test_item fix">
                                    <div class="item_img">
                                        <img class="img-circle" src="${ pageContext.servletContext.contextPath }/resources/images/test-img1.jpg" alt="" />
                            ...
                            <div class="col-md-6">
                                <div class="test_item fix sm-m-top-30">
                                    <div class="item_img">
                                        <img class="img-circle" src="${ pageContext.servletContext.contextPath }/resources/images/test-img2.jpg" alt="" />
                                        <i class="fa fa-quote-left"></i>
                                    </div>
                        ...
                        <div class="main_brand text-center">
                            <div class="col-md-2 col-sm-4 col-xs-6">
                                <div class="brand_item sm-m-top-20">
                                    <img src="${ pageContext.servletContext.contextPath }/resources/images/cbrand-img1.png" alt="" />
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-4 col-xs-6">
                                <div class="brand_item sm-m-top-20">
                                    <img src="${ pageContext.servletContext.contextPath }/resources/images/cbrand-img2.png" alt="" />
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-4 col-xs-6">
                                <div class="brand_item sm-m-top-20">
                                    <img src="${ pageContext.servletContext.contextPath }/resources/images/cbrand-img3.png" alt="" />
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-4 col-xs-6">
                                <div class="brand_item sm-m-top-20">
                                    <img src="${ pageContext.servletContext.contextPath }/resources/images/cbrand-img4.png" alt="" />
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-4 col-xs-6">
                                <div class="brand_item sm-m-top-20">
                                    <img src="${ pageContext.servletContext.contextPath }/resources/images/cbrand-img5.png" alt="" />
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-4 col-xs-6">
                                <div class="brand_item sm-m-top-20">
                                    <img src="${ pageContext.servletContext.contextPath }/resources/images/cbrand-img6.png" alt="" />
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-md-3">
                                <div class="widget_item widget_latest sm-m-top-50">
                                    ...
                                    <div class="widget_latst_item m-top-30">
                                        <div class="item_icon"><img src="${ pageContext.servletContext.contextPath }/resources/images/ltst-img-1.jpg" alt="" /></div>
                                    ...
                                    <div class="widget_latst_item m-top-30">
                                        <div class="item_icon"><img src="${ pageContext.servletContext.contextPath }/resources/images/ltst-img-2.jpg" alt="" /></div>
                                        <div class="widget_latst_item_text">
                                            <p>Lorem ipsum dolor sit amet, consectetur</p>
                                            <a href="">21<sup>th</sup> July 2016</a>
                                        </div>
                                    ...
                                    <div class="widget_latst_item m-top-30">
                                        <div class="item_icon"><img src="${ pageContext.servletContext.contextPath }/resources/images/ltst-img-3.jpg" alt="" /></div>
                                        <div class="widget_latst_item_text">
                                            <p>Lorem ipsum dolor sit amet, consectetur</p>
                                            <a href="">21<sup>th</sup> July 2016</a>
                                        </div>
