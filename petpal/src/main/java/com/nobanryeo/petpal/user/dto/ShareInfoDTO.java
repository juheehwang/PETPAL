...
public class ShareInfoDTO {
	...
	public ShareInfoDTO(int total, int nowPage, int cntPerPage) {
		setNowPage(nowPage);
	...
	public ShareInfoDTO(int boardCode, String boardTitle, String boardContent, int boardViews, Date boardPostDate,
			...
			String pictureUtilPath, String keyWord, int nowPage, int startPage, int endPage, int total, int cntPerPage,
	...
	public String toString() {
		return "ShareInfoDTO [boardCode=" + boardCode + ", boardTitle=" + boardTitle + ", boardContent=" + boardContent
				...
				+ pictureUtilPath + ", keyWord=" + keyWord + ", nowPage=" + nowPage + ", startPage=" + startPage
