...
public class ReviewReportDTO {
	...
	public ReviewReportDTO(int reportCode, String reportTitle, String reportContent, Date reportDate, int decisionCode,
			int userCode, int boardCode) {
		super();
	...
	public String toString() {
		return "ReviewReportDTO [reportCode=" + reportCode + ", reportTitle=" + reportTitle + ", reportContent="
