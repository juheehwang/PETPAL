...
public class ReviewReplyDTO {
	...
	public ReviewReplyDTO(int replyCode, String replyContent, Date replyDate, String replyDeleteYN, String reportYN,
	...
	public String toString() {
		return "ReviewReplyDTO [replyCode=" + replyCode + ", replyContent=" + replyContent + ", replyDate=" + replyDate
				+ ", replyDeleteYN=" + replyDeleteYN + ", reportYN=" + reportYN + ", boardCode=" + boardCode
