...
public class ReviewDTO {
	...
	public ReviewDTO(int boardCode, String boardTitle, String boardContent, int boardViews, Date boardPostDate,
	...
	public String toString() {
		return "ReviewDTO [boardCode=" + boardCode + ", boardTitle=" + boardTitle + ", boardContent=" + boardContent
